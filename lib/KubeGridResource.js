...
KubeGridResource.prototype = {
          ...
          try {
            if (response.error) {
              ...
              if (res.statusCode === 401) {
                ...
                err = new Error.KubeGridPermissionError(response);
              } else if (res.statusCode === 429) {
                err = new Error.KubeGridRateLimitError(response);
              } else {
            ...
            return callback.call(
              ...
              new Error.KubeGridAPIError({
                message: 'Invalid JSON received from the KubeGrid API',
                response,
                exception: e
              }),
              null
  ...
  _makeHeaders(
    ...
    const defaultHeaders = {
      ...
      Authorization: auth ?
        `Bearer ${auth}` : this._kubegrid.getApiField('auth'),
        ...
        if (socket.connecting) {
          socket.once(
            ...
            () => {
              ...
              // console.log('send payload', requestData);
